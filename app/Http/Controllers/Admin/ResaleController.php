...
use App\Http\Requests\Admin\ResaleRequest;
use App\Http\Resources\Admin\ProjectResource;
use App\Http\Resources\Admin\PropertyResource;
use App\Http\Resources\Admin\ResaleResource;
...
class ResaleController extends Controller
{
    ...
    {
        return view('admin.resales.index');
    }

    public function index(Request $request)
    {
        $properties = Property::with('media')->where('property_type_id',1)->paginate(10);
        return responseJson(ResaleResource::collection($properties->items()),'',200,getPaginates($properties));
    }

    public function store(ResaleRequest $request)
    {
    ...
    public function update(ResaleRequest $request,$id)
    {
