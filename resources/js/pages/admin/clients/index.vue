          ...
          <div class="card custom-card">
            <div class="card-header justify-content-between">
              ...
              <div class="prism-toggle">
                <button @click="showModelCreate" class="btn btn-sm btn-primary-light" data-bs-toggle="modal" data-bs-target="#client-model">
                    ...
                    <td>
                      <div class="hstack gap-2 fs-15">
                        <button
                                ...
                                data-bs-toggle="modal" data-bs-target="#client-model"
