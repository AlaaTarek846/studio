                ...
                <div class="modal-body">
                    <div class="row">
                      ...
                      <div class="col-md-12 mt-3">
                          <label class="form-label">صورة  (402 * 552)</label>
  ...
  function resetModal() {
    ...
    setTimeout(async () => {
      if (props.type != 'edit') {
        ...
        adminApi.get(`property-types/${id.value}`)
            .then((res) => {
              loading.value = true;
              let l = res.data.data;
  ...
  const AddSubmit = () =>  {
      ...
      if (props.type !== 'edit') {
        if (!v$.value.$error) {
          is_disabled.value = false;
          loading.value = true;
          adminApi.post(`property-types`, formData)
              .then((res) => {
                Swal.fire({
                  icon: 'success',
        ...
        adminApi.post(`property-types/${id.value}`,formData)
            .then((res) => {
              Swal.fire({
                icon: 'success',
